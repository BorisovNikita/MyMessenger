...
import { GiftedChat, InputToolbar, Composer, Send, Day, Message, Bubble, Time } from 'react-native-gifted-chat';
...
const Chat = ({ route }) => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io.connect("http://192.168.1.38:9000"); // Address of the Signal server
